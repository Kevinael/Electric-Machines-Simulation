...
# ═══════════════════════════════════════════════════════════════════════════
# BLOCO E — CIRCUITO EQUIVALENTE (delegado a ceq.py)
# ═══════════════════════════════════════════════════════════════════════════

from ceq import render_circuit as _render_circuit_ceq


def render_circuit(mp: MachineParams, dark: bool) -> None:
    """Delega o desenho do circuito equivalente para ceq.py."""
    _render_circuit_ceq(mp, dark, _palette)
